_base_ = [
    '../_base_/schedules/schedule_1x.py', '../_base_/default_runtime.py', '../_base_/datasets/dota_rbox.py',
]
...
model = dict(
    ...
    test_cfg=dict(score_thr=0.01, nms=dict(type='nms_rotated', iou_threshold=0.6))
)
